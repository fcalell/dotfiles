...
map({ "n", "t" }, "<C-h>", "<C-\\><C-n><C-w>h", { noremap = false, desc = "Focus on left window" })
map({ "n", "t" }, "<C-j>", "<C-\\><C-n><C-w>j", { noremap = false, desc = "Focus on below window" })
map({ "n", "t" }, "<C-k>", "<C-\\><C-n><C-w>k", { noremap = false, desc = "Focus on above window" })
map({ "n", "t" }, "<C-l>", "<C-\\><C-n><C-w>l", { noremap = false, desc = "Focus on right window" })
